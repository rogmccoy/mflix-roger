...
const MongoError = require("mongodb").MongoError
  ...
  ; (async () => {
    try {
      ...
      const host = "mongodb+srv://m220student:m220password@mflix-udvjo.mongodb.net/test?retryWrites=true"
      
      // "mongodb://<your atlas connection uri from your .env file"
      const client = await MongoClient.connect(
        host,
        { useNewUrlParser: true },
      )
      const mflix = await client.db("mflix")
      // const movies = await client.db("mflix").collection("movies")
      ...
      const movies = await mflix.collection("movies")
      console.log(
        "\x1b[32m",
