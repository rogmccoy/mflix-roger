  ...
  static async getMoviesByCountry(countries) {
    ...
    */
    ...
    try {
      ...
      // wire.
      // cursor = await movies.find({ countries: {$in: countries} }).limit(1)
  ...
  static async getMovieByID(id) {
    try {
      ...
      const pipeline = [
        {
          ...
          $lookup: {
            from: 'comments',
            /* this is creeating a variable called id and setting it
            to the value of _id in the movies collection */
            let: { 'id': '$_id' },
            pipeline: [
              {
                $match:
      ...
      */
      ...
      // let errString = 'Error: Argument passed in must be a single String of 12 bytes or a string of 24 hex characters'
